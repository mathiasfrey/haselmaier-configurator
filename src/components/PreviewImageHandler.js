...
export const ModalImagesPath = {
  ...
  mit_blende: <img src={mit_blende} height="150" width="250" alt="ref"/>,
   //Technik"
  einseitig: <img src={einseitig} height="150" width="250" alt="ref" />,
  beidseitig: <img src={beidseitig} height="150" width="250" alt="ref" />,
  mit_container: <img src={mit_container} height="150" width="250" alt="ref" />,
  ohne_container: <img src={ohne_container} height="150" width="250" alt="ref" />
